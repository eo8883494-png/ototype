...
<style>
body{{margin:0;background:radial-gradient(900px 500px at 80% -10%, {color}44, transparent 60%),#0E0F1A;color:#F4F2FF;font-family:'M PLUS Rounded 1c',sans-serif;min-height:100dvh;display:flex;align-items:center;justify-content:center;text-align:center;padding:24px;line-height:1.8}}
.code{{font-size:13px;font-weight:800;letter-spacing:.35em;color:{color}}}
h1{{font-size:clamp(30px,8vw,40px);font-weight:900;margin:8px 0 4px}}
.catch{{opacity:.9;font-size:15px}}
a{{display:inline-block;margin-top:26px;background:linear-gradient(90deg,{color},#B9B0FF);color:#14162B;text-decoration:none;font-weight:800;font-size:16px;padding:15px 34px;border-radius:999px}}
p.f{{margin-top:34px;font-size:11px;color:#9FA3C0}}
</style>
</head>
<body>
<main>
...
<a href="../index.html">あなたも診断する（無料・約1分）</a>
